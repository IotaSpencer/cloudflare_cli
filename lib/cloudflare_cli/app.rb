...
class App
  ...
  flag [:e,:email], desc: 'Cloudflare E-Mail', default_value: '', arg_name: 'EMAIL'
  flag [:k,'api-key'], desc: 'Cloudflare API Key', default_value: '', arg_name: 'APIKEY'
